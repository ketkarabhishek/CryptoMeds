...
import { Dialog, DialogTitle, Grid, IconButton, Typography, Divider, DialogContent, TextField, DialogActions, Button } from '@material-ui/core'
...
function AddPrescriptionDialog(props) {
    ...
    return (
        <Dialog onClose={handleClose} open={open} fullWidth maxWidth="sm">
            ...
            <Divider/>
            <DialogContent>
                <TextField value={prescriber} onChange={handlePrescriberChange} label="Prescriber" fullWidth/>
                <KeyboardDatePicker
                    // variant="inline"
                    format="DD/MM/YYYY"
                    margin="normal"
...
export default connect(mapStateToProps, mapDispachToProps)(AddPrescriptionDialog)