        ...
        <Dialog onClose={handleClose} open={open} fullWidth maxWidth="sm">
             <DialogTitle disableTypography>
                <Grid container justify="space-between">
                    <Typography variant="h4" style={{fontSize: '1.5rem'}}>New Allergy </Typography>
            ...
            <DialogContent>
                ...
                <TextField value={substance} onChange={handleSubstanceChange} variant="outlined" margin="normal" label="Substance" fullWidth/>
                <TextField value={reaction} onChange={handleReactionChange} variant="outlined" margin="normal" label="Reaction" fullWidth/>
                <KeyboardDatePicker
                    // variant="inline"
                    format="DD/MM/YYYY"
                    margin="normal"
