      ...
      <DialogContent>
        <Grid container alignItems="center" justify="center" direction="column">
          <Typography variant="h5" align="center" gutterBottom>
            You’ll need a wallet to store all your Health Records!
          </Typography>
          ...
          <Typography>
            This will also act as your login to the site (no extra password
            needed).
          </Typography>
          <Typography variant="caption">
            Currently Metamask is the only wallet supported.
          </Typography>
        </Grid>
      </DialogContent>
