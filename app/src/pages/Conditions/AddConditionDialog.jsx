        ...
        <Dialog onClose={handleClose} open={open} fullWidth maxWidth="sm">
             <DialogTitle disableTypography>
                <Grid container justify="space-between">
                    <Typography variant="h4" style={{fontSize: '1.5rem'}}>New Condition </Typography>
            ...
            <DialogContent>
                ...
                <TextField value={asserter} onChange={handleAsserterChange} variant="outlined" margin="normal" label="Asserter" fullWidth/>
                <TextField value={clinicalStatus} onChange={handleCinicalStatusChange} variant="outlined" margin="normal" label="CinicalStatus" fullWidth/>
                <KeyboardDatePicker
                    // variant="inline"
                    format="DD/MM/YYYY"
                    margin="normal"
