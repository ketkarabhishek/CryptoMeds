        ...
        <div>
            <Card>
                <CardContent>
                    ...
                    <Typography color="textSecondary" variant="subtitle1" gutterBottom>{dayjs(data.recordedDate).format("Do MMM, YYYY")}</Typography>
            ...
            <AllergyViewDialog open={open} onClose={handleClose} data={data}></AllergyViewDialog>
        </div>
    )
}
