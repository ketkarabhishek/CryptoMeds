  ...
  useEffect(() => {
    async function getUserData() {
      const dataHash = await contract.methods
        .getPatient(account, sign.message, sign.signature)
        .call();
